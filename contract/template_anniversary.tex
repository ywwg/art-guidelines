...
% Import project-specific parameter overrides, if any.
\IfFileExists{parameters.tex}{\input{parameters.tex}}{}
% Update these dates for the new year
...
\begin{document}
\chead[Firefly \grant{} \the\year{}]{\project{}}
...
\fac{} has agreed to provide funding in the amount of \amount{}\ USD for the project as determined by the Art Grant Core.  The
...
\item \fac{} will retain 50\% of the grant funding as a performance deposit.  The first payment (10\% of the total alotted
  funding) will be disbursed upon receiving the signed contract; the second payment (20\% of the total funding)
  will be disbursed upon completion of Firefly Arts Festival \the\year{}; the third payment will be disbursed upon completion of the Figment \the\year{}
  event and completion of all requirements outlined in this document.
